...
class MainPage(BasePage):
    ...
    def get_nominal_buttons(self):
        ...
        return self.find_elements(MainPageLocators.NOMINAL_BUTTONS, 5)
    ...
    def get_nominal_input_value(self):
        ...
        return self.find_element(MainPageLocators.NOMINAL_INPUT, 5).get_attribute("value")

    def check_input_equals_nominal_button(self):
        """Проверка номинала в инпуте, сравнение со значением номинала в активной кнопке"""
        button = self.find_element(MainPageLocators.ACTIVE_NOMINAL_BUTTON, 5)
    ...
    def check_is_button_active(self, button):
        ...
        assert button == self.find_element(MainPageLocators.ACTIVE_NOMINAL_BUTTON, 5), \
